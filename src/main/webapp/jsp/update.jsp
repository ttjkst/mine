...
<html>
	<head>
		...
		var wordId = ${word.wId};
		var kindName = "${word.wKind.kName}";
		var aboutWhat = "${word.wKind.aboutwhat.name}";
		var wordPath= "${word.wPath}";
		var intorPath= "${word.introductionPath}";
		var title = "${word.wTitle}";
		var author = "${word.wAuthor}";
		</script>
	</head>
 ...
 <script type="text/javascript" src="${pageContext.request.contextPath}/js/react/built/updatePage.js"></script>
</html>
